...
export const THEME_COLOR_PRESETS = [
  {
    ...
    colors: {
      ...
      cardColor: '#211511',
      buttonHoverColor: '#2d1d18',
      primaryButtonColor: '#f97316',
      textColor: '#fff8f2',
      accentColor: '#fb7185',
      borderColor: '#4a3028',
      secondaryColor: '#b45379',
    },
  },
  {
    id: 'escuro-premium',
    ...
    colors: {
      ...
      cardColor: '#171f31',
      buttonHoverColor: '#243048',
      primaryButtonColor: '#d4a24c',
      textColor: '#f5f1e8',
      accentColor: '#d4a24c',
      borderColor: '#32405d',
  ...
  },
  {
    ...
    colors: {
      ...
      cardColor: '#1d1813',
      buttonHoverColor: '#2c241d',
      primaryButtonColor: '#c9a227',
      textColor: '#fff7e6',
      accentColor: '#d4af37',
      borderColor: '#4c3b21',
  ...
  },
  {
    ...
    colors: {
      ...
      cardColor: '#1a1411',
      buttonHoverColor: '#2a201a',
      primaryButtonColor: '#b08968',
      textColor: '#f7f1e8',
      accentColor: '#7f1d1d',
      borderColor: '#4d3b32',
  ...
  },
  {
    ...
    colors: {
      backgroundColor: '#1a0b0d',
      cardColor: '#291315',
      buttonHoverColor: '#361b1f',
      primaryButtonColor: '#d62828',
      textColor: '#fff4ef',
      accentColor: '#f77f00',
      borderColor: '#63343b',
      secondaryColor: '#8c1c13',
    },
  },
  {
    id: 'restaurante',
    ...
    colors: {
      ...
      cardColor: '#241d17',
      buttonHoverColor: '#332920',
      primaryButtonColor: '#c27c2c',
      textColor: '#fff7ee',
      accentColor: '#7b9e45',
      borderColor: '#564232',
      secondaryColor: '#7b9e45',
    },
  },
  {
    id: 'clinica',
    ...
    colors: {
      ...
      cardColor: '#dceef1',
      buttonHoverColor: '#cde4e8',
      primaryButtonColor: '#0f766e',
      textColor: '#12343b',
      accentColor: '#38bdf8',
      borderColor: '#a9c6cc',
      secondaryColor: '#8bbdc6',
    },
  },
  {
    id: 'loja-moderna',
